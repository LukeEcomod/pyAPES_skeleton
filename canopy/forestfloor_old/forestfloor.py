...
#            )
            ...
            if self.f_bryo > 0.0:
                ...
                # VAIKEA NÄHDÄ MIKÄ VIRKA 'KESKIMÄÄRÄISELLÄ' SAMMALKERROKSEN TILALLA / VOILLA?
                ...
                for bryo in self.bryotypes:
                    ...
                    # mean bryophyte temperature; bryo.coverage / self.f_bryo ensures sum(weights) == 1
                    states['bryo_temperature'] += bryo.coverage / self.f_bryo * states_bryo['temperature']
                ...
                # to ensure 'bryo_temperature' is correctly weighted
            ...
            if self.f_baresoil > 0.0:
                ...
                # muuta 'soil_surface_temperature' tähän ja kaikkialle muualle
    ...
    def shortwave_albedo(self):
        ...
        if self.snowpack.snowcover():
            ...
            # ALBEDOT bryo tilanmuuttujiksi, päivitetään bryo.run'ssa?
            if self.f_bryo > 0.0:
