...
class Bryophyte(object):
    ...
    def __init__(self, properties, initial_conditions=None):
        ...
        # compute vol. water contents corresponding to min & max gravimetric
        # water content. Assume that saturated water content == field capacity
        ...
        if 'field_capacity' not in properties['water_retention']:
            properties['water_retention']['field_capacity'] = field_capacity
        if 'theta_r' not in properties['water_retention']:    
            properties['water_retention']['theta_r'] = residual_water_content
        if 'theta_s' not in properties['water_retention']:
            properties['water_retention']['theta_s'] = field_capacity
        ...
        if initial_conditions is not None:
            ...
            #: [g g\ :sup:`-1`\ ]
            self.water_content = np.minimum(initial_conditions['water_content'],
