...
from canopy.canopy_dev import CanopyModel
...
class Model(object):
    ...
    def __init__(self,
        ...
        self.Nground_types = len(self.canopy_model.forestfloor.groundtypes)
    ...
    def run(self):
        ...
        for k in range(0, self.Nsteps):
            ...
            forcing_output = {
                    ...
                    'precipitation': self.forcing['Prec'].iloc[k] * WATER_DENSITY,
        ...
        gtnames = [gt.name for gt in self.canopy_model.forestfloor.groundtypes]
        gtnames.sort()
